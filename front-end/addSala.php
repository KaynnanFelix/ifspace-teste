...
if(isset($_POST['adicionar'])){
    ...
    addJson("../back-end/jsons/espacos/salas/salas.json",$register);
...
<html lang="pt-br">
    ...
    <title>IFSpace - Adicionar Sala</title>
...
<div class="input-group mb-3">
  <div class="input-group-prepend">
    <span class="input-group-text" id="inputGroup-sizing-default">Nome da Sala</span>
  </div>
...
<div class="input-group mb-3">
  <div class="input-group-prepend">
    <span class="input-group-text" id="inputGroup-sizing-default">Localização da Sala</span>
  </div>
