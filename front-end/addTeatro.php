...
if(isset($_POST['adicionar'])){
    ...
    addJson("../back-end/jsons/espacos/teatro/teatros.json",$register);
...
<html lang="pt-br">
    ...
    <title>IFSpace - Adicionar Teatro</title>
...
include "layout.php";
?>
<h2>Adicionar teatro</h2>
<form method="post" action="<?php echo $_SERVER['PHP_SELF'] ?>">
<div class="input-group mb-3">
  <div class="input-group-prepend">
    <span class="input-group-text" id="inputGroup-sizing-default">Nome do teatro</span>
  </div>
